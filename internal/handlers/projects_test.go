...
func TestFetchProjects(t *testing.T) {
	tests := []struct {
		name  string
		hosts []string
		want  []components.ProjectTemplate
	}{
...
var GithubExpected = []components.ProjectTemplate{
	{
		Host:        "Github",
...
var BggExpected = []components.ProjectTemplate{
	{
...
var Cults3DExpected = []components.ProjectTemplate{
	{
		Host:  "Cults3D",
